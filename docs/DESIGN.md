...
| `grill` | scope's `intake.md` for a document subject, `grill.md`, `asking.md` | settled tree printed and, on card only, stop or `--out`, written to disk; chosen next step run |
